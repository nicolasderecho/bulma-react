...
var Content = function (originalProps) {
    ...
    var Element = htmlElementFor(as, 'div');
    var classes = classNames(className, 'content', sizeClassFor(size), { 'has-text-centered': isEnabled(originalProps, 'centered') });
...
var IconWrapper = function (_a) {
    ...
    var classes = classNames(className, 'icon', sizeClassFor(size), textClassFor(hasText), iconPositionClassFor(position));
    return createElement(Element, __assign({ className: classes }, props));
};
...
var Image = function (_a) {
    ...
    var classes = classNames(className, 'image', (_b = {}, _b["is-" + is] = !!is, _b), checkEnabledProperties(originalProps, ['fullwidth']));
    var childClasses = classNames(imageClass, checkEnabledProperties(originalProps, ['rounded']));
...
var Column = function (_a) {
    ...
    var classes = classNames.apply(void 0, __spreadArrays([className, 'column', columnSizeClassFor(columnSize), columnOffsetlassFor(offset), { 'is-narrow': isEnabled(originalProps, 'narrow') }], derivedClasses.narrow, derivedClasses.device, derivedClasses.deviceColumnSizes, derivedClasses.deviceOffsets));
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var Columns = function (_a) {
    ...
    var Element = htmlElementFor(as, 'div');
    var classes = classNames.apply(void 0, __spreadArrays([className, 'columns', checkEnabledProperties(originalProps, ['gapless', 'multiline', 'centered', 'vcentered']), deviceActiveClassFor(from), gapSizeFor(gap), variableGapClassFor(gap, originalProps)], gapSizeForDevices(originalProps)));
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var Buttons = function (_a) {
    ...
    var classes = classNames(className, 'buttons', sizeClassFor(size, 'are'), buttonPositionClassFor(position), addonsClassFor(props));
...
var OrderedList = function (props) { return React.createElement(List, __assign({ as: 'ol' }, props)); };
OrderedList.displayName = 'OrderedList';
OrderedList.Item = ListItem;
var UnorderedList = function (props) { return React.createElement(List, __assign({ as: 'ul' }, props)); };
UnorderedList.displayName = 'UnorderedList';
UnorderedList.Item = ListItem;
var DescriptionList = function (props) { return React.createElement(List, __assign({ as: 'dl' }, props)); };
DescriptionList.displayName = 'DescriptionList';
DescriptionList.Item = ListItem;

var FieldLabel = function (_a) {
    var className = _a.className, as = _a.as, size = _a.size, props = __rest(_a, ["className", "as", "size"]);
    var classes = classNames(className, 'field-label', sizeClassFor(size));
    var Element = htmlElementFor(as, 'div');
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var FieldBody = function (_a) {
    var className = _a.className, as = _a.as, size = _a.size, props = __rest(_a, ["className", "as", "size"]);
    var classes = classNames(className, 'field-body', sizeClassFor(size));
    var Element = htmlElementFor(as, 'div');
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var Control = function (originalProps) {
    ...
    var classes = classNames(className, 'control', checkEnabledProperties(originalProps, ['expanded', 'loading']), checkEnabledProperties(originalProps, ['hasIconsLeft', 'hasIconsRight'], { prefix: '' }), sizeClassFor(size));
    return React.createElement("div", __assign({ className: classes }, props));
};
...
var Input = function (originalProps) {
    ...
    var classes = classNames(className, 'input', colorClassFor(color), checkEnabledProperties(originalProps, ['expanded', 'rounded', 'static']), sizeClassFor(size), stateClassFor(state));
    return React.createElement("input", __assign({ className: classes }, props, !!htmlSize ? { size: Number(htmlSize) } : null));
};
...
var Help = function (originalProps) {
    ...
    var classes = classNames(className, 'help', colorClassFor(color));
    return React.createElement("p", __assign({ className: classes }, props));
};
...
var SelectWrapper = function (originalProps) {
    ...
    var Element = htmlElementFor(as, 'div');
    var classes = classNames(className, 'select', checkEnabledProperties(originalProps, ['fullwidth', 'multiple']), colorClassFor(color), sizeClassFor(size), stateClassFor(state));
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var Textarea = function (originalProps) {
    ...
    var classes = classNames(className, 'textarea', colorClassFor(color), sizeClassFor(size), stateClassFor(state), checkEnabledProperties(originalProps, ['hasFixedSize'], { prefix: '' }));
...
var SimpleCheckbox = function (_a) {
    ...
    var wrapperClasses = classNames(wrapperClassName, 'checkbox');
    return React.createElement("label", { className: wrapperClasses },
        React.createElement("input", __assign({ type: 'checkbox', className: classes }, props)),
        children);
};
...
var SimpleRadio = function (_a) {
    ...
    var wrapperClasses = classNames(wrapperClassName, 'radio');
    return React.createElement("label", { className: wrapperClasses },
        React.createElement("input", __assign({ type: 'radio', className: classes }, props)),
        children);
};
...
var DisabledFieldset = function (props) {
    return React.createElement("fieldset", __assign({}, props, { disabled: true }));
};
...
var Container = function (originalProps) {
    ...
    var Element = htmlElementFor(as, 'div');
    var classes = classNames(className, 'container', checkEnabledProperties(originalProps, ['fluid', 'fullhd', 'widescreen']));
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var LevelItem = function (originalProps) {
    ...
    var Element = htmlElementFor(as, 'div');
    var classes = classNames(className, 'level-item', { 'has-text-centered': isEnabled(originalProps, 'centered') });
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var LevelLeft = function (_a) {
    var className = _a.className, as = _a.as, props = __rest(_a, ["className", "as"]);
    var Element = htmlElementFor(as, 'div');
    var classes = classNames(className, 'level-left');
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var LevelRight = function (_a) {
    var className = _a.className, as = _a.as, props = __rest(_a, ["className", "as"]);
    var Element = htmlElementFor(as, 'div');
    var classes = classNames(className, 'level-right');
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var Level = function (originalProps) {
    ...
    var classes = classNames(className, 'level', { 'is-mobile': isEnabled(originalProps, 'mobile') });
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var MediaContent = function (_a) {
    var className = _a.className, as = _a.as, props = __rest(_a, ["className", "as"]);
    var Element = htmlElementFor(as, 'div');
    var classes = classNames(className, 'media-content');
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var MediaRight = function (_a) {
    var className = _a.className, as = _a.as, props = __rest(_a, ["className", "as"]);
    var Element = htmlElementFor(as, 'div');
    var classes = classNames(className, 'media-right');
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var MediaLeft = function (_a) {
    var className = _a.className, as = _a.as, props = __rest(_a, ["className", "as"]);
    var Element = htmlElementFor(as, 'div');
    var classes = classNames(className, 'media-left');
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var Media = function (_a) {
    ...
    var classes = classNames(className, 'media');
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var Footer = function (_a) {
    ...
    var classes = classNames(className, 'footer');
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var Section = function (_a) {
    ...
    var classes = classNames(className, 'section', (_b = {}, _b["is-" + spacing] = ['medium', 'large'].includes(spacing), _b));
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var HeroHead = function (_a) {
    var className = _a.className, as = _a.as, props = __rest(_a, ["className", "as"]);
    var Element = htmlElementFor(as, 'div');
    var classes = classNames(className, 'hero-head');
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var HeroBody = function (_a) {
    var className = _a.className, as = _a.as, props = __rest(_a, ["className", "as"]);
    var Element = htmlElementFor(as, 'div');
    var classes = classNames(className, 'hero-body');
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var HeroFoot = function (_a) {
    var className = _a.className, as = _a.as, props = __rest(_a, ["className", "as"]);
    var Element = htmlElementFor(as, 'div');
    var classes = classNames(className, 'hero-foot');
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var Tile = function (originalProps) {
    ...
    var Element = htmlElementFor(as, 'div');
    var classes = classNames(className, 'tile', { 'is-vertical': isEnabled(originalProps, 'vertical') }, hierarchyClassFor(hierarchy), horizontalClassFor(horizontalSize));
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var PanelHeading = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'panel-heading');
    return React.createElement("p", __assign({ className: classes }, props));
};
...
var PanelBlock = function (originalProps) {
    ...
    var Element = htmlElementFor(as, 'div');
    var classes = classNames(className, 'panel-block', checkEnabledProperties(originalProps, ['active']));
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var PanelIcon = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'panel-icon');
    return React.createElement("span", __assign({ className: classes }, props));
};
...
var PanelTabsItem = function (originalProps) {
    ...
    return React.createElement("a", __assign({ className: classes }, props));
};
...
var PanelTabs = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'panel-tabs');
    return React.createElement("p", __assign({ className: classes }, props));
};
...
var Panel = function (_a) {
    var className = _a.className, color = _a.color, props = __rest(_a, ["className", "color"]);
    var classes = classNames(className, 'panel', colorClassFor(color));
    return React.createElement("nav", __assign({ className: classes }, props));
};
...
var ModalBackground = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'modal-background');
    return React.createElement("div", __assign({ className: classes }, props));
};
...
var OutsideClickContext = React.createContext({ onOutsideClick: function () { }, isActive: false });
...
function useOutsideAlerter(closeOnClickOutside) {
    ...
    var _a = useState(false), clickedOutside = _a[0], setClickedOutside = _a[1];
    var _b = useContext(OutsideClickContext), onOutsideClick = _b.onOutsideClick, isActive = _b.isActive;
    var ref = useRef(null);
...
var ModalContent = function (_a) {
    ...
    var classes = classNames(className, 'modal-content');
    return React.createElement(OutsideAlerter, { closeOnClickOutside: closeOnClickOutside },
        React.createElement("div", __assign({ className: classes }, props)));
};
...
var ModalClose = function (_a) {
    ...
    var classes = classNames(className, 'modal-close', sizeClassFor(size));
    return React.createElement("button", __assign({ className: classes }, props, { "aria-label": 'close' }));
};
...
var ModalCardHead = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'modal-card-head');
    return React.createElement("header", __assign({ className: classes }, props));
};
...
var ModalCardTitle = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'modal-card-title');
    return React.createElement("p", __assign({ className: classes }, props));
};
...
var ModalCardBody = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'modal-card-body');
    return React.createElement("section", __assign({ className: classes }, props));
};
...
var ModalCardFoot = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'modal-card-foot');
    return React.createElement("footer", __assign({ className: classes }, props));
};
...
var ModalCard = function (_a) {
    ...
    var classes = classNames(className, 'modal-card');
    return React.createElement(OutsideAlerter, { closeOnClickOutside: closeOnClickOutside },
        React.createElement("div", __assign({ className: classes }, props)),
        ";");
};
...
var Modal = function (originalProps) {
    ...
    var onOutsideClick = useCallback(function () { return closeModal(); }, [closeModal]);
    useEffect(function () {
        onMount();
    ...
    var classes = classNames(className, 'modal', checkEnabledProperties(originalProps, ['active']));
    return React.createElement("div", __assign({ className: classes }, props),
        React.createElement(OutsideClickProvider, { value: { onOutsideClick: onOutsideClick, isActive: !!active } },
            background === false ? null : React.createElement(ModalBackground, null),
            children));
};
...
var CheckRadio = forwardRef(function (originalProps, ref) {
    ...
    var classes = classNames(inputClass, 'is-checkradio', colorClassFor(color), sizeClassFor(size), checkEnabledProperties(originalProps, ['rtl', 'circle', 'block']), checkEnabledProperties(originalProps, ['hasNoBorder', 'hasBackgroundColor'], { prefix: '' }));
    return React.createElement(React.Fragment, null,
        React.createElement("input", __assign({ id: id, type: type, className: classes, name: name, ref: ref }, props, !!htmlSize ? { size: Number(htmlSize) } : null)),
...
var Radio = function (props) {
    return React.createElement(CheckRadio, __assign({ type: 'radio' }, props));
};
...
var CheckBox = forwardRef(function (originalProps, ref) {
    ...
    return React.createElement(CheckRadio, __assign({ type: 'checkbox', ref: inputRef }, props));
});
...
var Breadcrumb = function (_a) {
    ...
    var classes = classNames(className, 'breadcrumb', alignmentClassFor(alignment), sizeClassFor(size), separatorClassFor(separator));
    var ulClasses = classNames(ulClassName);
    return React.createElement("nav", __assign({ "aria-label": 'breadcrumbs', className: classes }, props),
        React.createElement("ul", { className: ulClasses }, children));
};
...
var CardImage = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'card-image');
    return React.createElement("div", __assign({ className: classes }, props));
};
...
var CardFooterItem = function (_a) {
    var className = _a.className, as = _a.as, props = __rest(_a, ["className", "as"]);
    var classes = classNames(className, 'card-footer-item');
...
var CardHeaderTitle = function (originalProps) {
    var className = originalProps.className, as = originalProps.as, centered = originalProps.centered, props = __rest(originalProps, ["className", "as", "centered"]);
    var Element = htmlElementFor(as, 'p');
    var classes = classNames(className, 'card-header-title', checkEnabledProperties(originalProps, ['centered']));
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var CardHeaderIcon = function (_a) {
    var className = _a.className, as = _a.as, props = __rest(_a, ["className", "as"]);
    var Element = htmlElementFor(as, 'span');
    var classes = classNames(className, 'card-header-icon');
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var DropdownTrigger = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'dropdown-trigger');
    return React.createElement("div", __assign({ className: classes }, props));
};
...
var DropdownMenu = function (_a) {
    ...
    return React.createElement("div", __assign({ className: classes }, props, { role: 'menu' }));
};
...
var DropdownContent = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'dropdown-content');
    return React.createElement("div", __assign({ className: classes }, props));
};
...
var DropdownDivider = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'dropdown-divider');
    return React.createElement("hr", __assign({ className: classes }, props));
};
...
var DropdownItem = function (originalProps) {
    var className = originalProps.className, as = originalProps.as, active = originalProps.active, props = __rest(originalProps, ["className", "as", "active"]);
    var Element = htmlElementFor(as, 'a');
    var classes = classNames(className, 'dropdown-item', checkEnabledProperties(originalProps, ['active']));
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var Dropdown = function (originalProps) {
    ...
    var classes = classNames(className, 'dropdown', checkEnabledProperties(originalProps, ['active', 'up', 'right', 'hoverable']));
    return React.createElement("div", __assign({ className: classes }, props));
};
...
var MenuLabel = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'menu-label');
    return React.createElement("p", __assign({ className: classes }, props));
};
...
var MenuList = function (_a) {
    ...
    var classes = classNames(className, 'menu-list');
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var Menu = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'menu');
    return React.createElement("aside", __assign({ className: classes }, props));
};
...
var MessageBody = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'message-body');
    return React.createElement("div", __assign({ className: classes }, props));
};
...
var MessageHeader = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'message-header');
    return React.createElement("div", __assign({ className: classes }, props));
};
...
var Message = function (_a) {
    ...
    var classes = classNames(className, 'message', colorClassFor(color), sizeClassFor(size));
    return React.createElement("article", __assign({ className: classes }, props));
};
...
var TabsItem = function (originalProps) {
    ...
    var element = includeLink
        ? React.createElement("li", __assign({ className: classes }, props),
            " ",
            React.createElement("a", null, children),
            " ")
        : React.createElement("li", __assign({ className: classes }, props, { children: children }));
    return element;
};
...
var Tabs = function (originalProps) {
    ...
    var classes = classNames(className, 'tabs', sizeClassFor(size), alignmentClassFor(alignment), checkEnabledProperties(originalProps, ['boxed', 'rounded', 'fullwidth', 'toggle', 'toggleRounded']));
    var ulClasses = classNames(ulClassName);
    return React.createElement("div", __assign({ className: classes }, props),
        React.createElement("ul", { className: ulClasses }, children));
};
...
var NavbarBurger = function (originalProps) {
    var className = originalProps.className, active = originalProps.active, props = __rest(originalProps, ["className", "active"]);
    var classes = classNames(className, 'navbar-burger', 'burger', checkEnabledProperties(originalProps, ['active']));
    return React.createElement("a", __assign({ className: classes }, props, { role: 'button', "aria-label": 'menu', "aria-expanded": 'false' }),
...
var NavbarMenu = function (originalProps) {
    var className = originalProps.className, active = originalProps.active, props = __rest(originalProps, ["className", "active"]);
    var classes = classNames(className, 'navbar-menu', checkEnabledProperties(originalProps, ['active']));
    return React.createElement("div", __assign({ className: classes }, props));
};
...
var NavbarStart = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'navbar-start');
    return React.createElement("div", __assign({ className: classes }, props));
};
...
var NavbarEnd = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'navbar-end');
    return React.createElement("div", __assign({ className: classes }, props));
};
...
var NavbarItem = function (originalProps) {
    ...
    var classes = classNames(className, 'navbar-item', checkEnabledProperties(originalProps, ['dropdown', 'dropdownUp'], { prefix: 'has' }), checkEnabledProperties(originalProps, ['expanded', 'tab', 'active', 'hoverable']));
    return React.createElement(Element, __assign({ className: classes }, props));
};
...
var NavbarLink = function (originalProps) {
    ...
    var classes = classNames(className, 'navbar-link', checkEnabledProperties(originalProps, ['arrowless']));
    // eslint-disable-next-line
    return React.createElement("a", __assign({ className: classes }, props));
};
...
var NavbarDropdown = function (originalProps) {
    ...
    var classes = classNames(className, 'navbar-dropdown', checkEnabledProperties(props, ['right']));
    return React.createElement("div", __assign({ className: classes }, props));
};
...
var NavbarDivider = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'navbar-divider');
    return React.createElement("hr", __assign({ className: classes }, props));
};
...
var Navbar = function (originalProps) {
    ...
    var classes = classNames(className, 'navbar', checkEnabledProperties(originalProps, ['fixedTop', 'fixedBottom', 'transparent', 'spaced']), colorClassFor(color));
    return React.createElement("nav", __assign({ className: classes }, props, { role: 'navigation', "aria-label": 'main navigation' }));
};
...
var PaginationEllipsis = function (_a) {
    ...
    var classes = classNames(className, 'pagination-ellipsis');
    return React.createElement("li", null,
        React.createElement("span", __assign({ className: classes }, props), ellipsisText));
};
...
var PaginationPrevious = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'pagination-previous');
    // eslint-disable-next-line
    return React.createElement("a", __assign({ className: classes }, props));
};
...
var PaginationNext = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'pagination-next');
    // eslint-disable-next-line
    return React.createElement("a", __assign({ className: classes }, props));
};
...
var PaginationList = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var classes = classNames(className, 'pagination-list');
...
var PaginationLink = function (originalProps) {
    ...
    var Element = htmlElementFor(as, 'a');
    var classes = classNames(className, 'pagination-link', checkEnabledProperties(originalProps, ['current']));
    return React.createElement("li", null,
        React.createElement(Element, __assign({ className: classes }, props)));
};
...
var Pagination = function (originalProps) {
    ...
    var classes = classNames(className, 'pagination', sizeClassFor(size), alignmentClassFor(alignment), checkEnabledProperties(originalProps, ['rounded']));
    return React.createElement("nav", __assign({ className: classes }, props, { role: 'navigation', "aria-label": 'pagination' }));
};
