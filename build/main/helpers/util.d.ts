...
export declare const isSizeNumber: (value: any) => value is 6 | 3 | 4 | "1" | 1 | "2" | 2 | "3" | "4" | "5" | 5 | "6";
...
export declare const isState: (value: any) => value is "hovered" | "focused" | "normal" | "active";
...
export declare const isPosition: (value: any) => value is Position;
...
export declare const positionClassFor: (position: Position | unknown, { device, suffix }?: {
    device?: string;
    suffix?: string;
}) => ClassNameProp;
